...
public static class Easing
{
    ...
    public static Vector3 Ease(EasingType type, Vector3 a, Vector3 b, float t)
    {
        switch (type)
        {
            case EasingType.Linear:
    ...
    #region Quadratic
    public static Vector3 EaseInQuadratic(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInQuadratic(t);
    }

    public static Vector3 EaseOutQuadratic(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutQuadratic(t);
    }

    public static Vector3 EaseInOutQuadratic(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutQuadratic(t);
    }
    ...
    #endregion
    #region Cubic
    public static Vector3 EaseInCubic(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInCubic(t);
    }

    public static Vector3 EaseOutCubic(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutCubic(t);
    }

    public static Vector3 EaseInOutCubic(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutCubic(t);
    }
    ...
    #endregion
    #region Quart
    public static Vector3 EaseInQuart(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInQuart(t);
    }

    public static Vector3 EaseOutQuart(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutQuart(t);
    }

    public static Vector3 EaseInOutQuart(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutQuart(t);
    }
    #endregion
    #region Quint
    public static Vector3 EaseInQuint(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInQuint(t);
    }

    public static Vector3 EaseOutQuint(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutQuint(t);
    }

    public static Vector3 EaseInOutQuint(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutQuint(t);
    }
    ...
    #endregion
    #region Sine
    public static Vector3 EaseInSine(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInSine(t);
    }

    public static Vector3 EaseOutSine(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutSine(t);
    }

    public static Vector3 EaseInOutSine(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutSine(t);
    }
    ...
    #endregion
    #region Expo
    public static Vector3 EaseInExpo(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInExpo(t);
    }

    public static Vector3 EaseOutExpo(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutExpo(t);
    }

    public static Vector3 EaseInOutExpo(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutExpo(t);
    }
    ...
    #endregion
    #region Circ
    public static Vector3 EaseInCirc(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInCirc(t);
    }

    public static Vector3 EaseOutCirc(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutCirc(t);
    }

    public static Vector3 EaseInOutCirc(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutCirc(t);
    }
    ...
    #endregion
    #region Back
    public static Vector3 EaseInBack(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInBack(t);
    }

    public static Vector3 EaseOutBack(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutBack(t);
    }

    public static Vector3 EaseInOutBack(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutBack(t);
    }
    ...
    #endregion
    #region Bounce
    public static Vector3 EaseInBounce(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInBounce(t);
    }

    public static Vector3 EaseOutBounce(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseOutBounce(t);
    }

    public static Vector3 EaseInOutBounce(Vector3 a, Vector3 b, float t)
    {
        return a + (b - a) * EaseInOutBounce(t);
    }
